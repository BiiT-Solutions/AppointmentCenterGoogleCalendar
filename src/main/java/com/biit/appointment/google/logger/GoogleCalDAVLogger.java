package com.biit.appointment.google.logger;
 ...
 */
public class GoogleCalDAVLogger extends BasicLogger {

    private static final Logger LOGGER = LoggerFactory.getLogger(GoogleCalDAVLogger.class);
